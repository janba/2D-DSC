...
public:
    ...
    /**
     Draws the faces with the colors given as input.
     */
    static void draw_destination_faces(const DSC2D::DeformableSimplicialComplex& complex, const HMesh::FaceAttributeVector<DSC2D::vec3> &colors);
    ...
    /**
     Draws the faces using the 'jet' color scheme.
     */
    static void draw_destination_faces(const DSC2D::DeformableSimplicialComplex& complex, const HMesh::FaceAttributeVector<double> &values);
    
    /**
     Draws the faces using the 'jet' color scheme.
     */
    static void draw_faces(const DSC2D::DeformableSimplicialComplex& complex, const HMesh::VertexAttributeVector<double> &values);
    
    /**
     Draws the faces using the 'jet' color scheme.
     */
    static void draw_destination_faces(const DSC2D::DeformableSimplicialComplex& complex, const HMesh::VertexAttributeVector<double> &values);
     ...
     */
    static void draw_arrows(const DSC2D::DeformableSimplicialComplex& complex, const HMesh::VertexAttributeVector<DSC2D::vec2> &arrows, DSC2D::vec3 color = ORANGE, bool origin_movable = true);
    static void draw_edge_arrows(const DSC2D::DeformableSimplicialComplex& dsc, const HMesh::HalfEdgeAttributeVector<DSC2D::vec2> &arrows, DSC2D::vec3 color = ORANGE);
